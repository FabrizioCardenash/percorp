    ...
    <section id="metodologia" ref={sectionRef} className="relative py-24 md:py-32 bg-gradient-to-b from-gray-950 to-black text-white overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="relative">
          {/* Connection line */}
          <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#FF6B00]/30 to-transparent" />
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
            {steps.map((step, index) => (
              ...
              >
                <div className="relative z-10 w-16 h-16 mx-auto mb-4 bg-black border-2 border-[#FF6B00] rounded-full flex items-center justify-center">
