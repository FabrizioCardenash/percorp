...
export const metadata: Metadata = {
  title: 'Energía Inteligente | PERCORP - Infraestructura Eléctrica y Optimización Energética',
  ...
  keywords: ['energía inteligente', 'infraestructura eléctrica', 'optimización energética', 'submetering', 'eficiencia energética', 'continuidad operacional'],
  openGraph: {
    title: 'Energía Inteligente | PERCORP',
